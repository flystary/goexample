...
func (c *queryClient) GetAge(ctx context.Context, opts ...grpc.CallOption) (Query_GetAgeClient, error) {
...
func (x *queryGetAgeClient) Send(m *UserInfo) error {
	return x.ClientStream.SendMsg(m)
}

func (x *queryGetAgeClient) CloseAndRecv() (*AgeInfo, error) {
...
func (UnimplementedQueryServer) GetAge(Query_GetAgeServer) error {
...
func _Query_GetAge_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(QueryServer).GetAge(&queryGetAgeServer{stream})
}
...
func (x *queryGetAgeServer) SendAndClose(m *AgeInfo) error {
	return x.ServerStream.SendMsg(m)
}

func (x *queryGetAgeServer) Recv() (*UserInfo, error) {
	m := new(UserInfo)
